...
namespace LuanNiao.Cache
{
    public class DefaultCacheRealization
    {
        ...
        /// 初始化一级缓存
        /// </summary>
        public static void InitLocalMemoryCahce(Manager cache)
        {
        ...
        public static void InitLocalRedisFromConfigCenter(Manager cache, string redisConnString, AbsLNLogger logger)
        {
            ...
            try
            {
                try
                {
                    ...
                    cache.PushNewClient(new Cache.CacheInstance(cacheInstance)
                    {
                        Available = true,
