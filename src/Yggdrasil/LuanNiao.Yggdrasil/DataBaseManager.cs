...
namespace LuanNiao.Yggdrasil
{
    ...
    public class DataBaseManager
    {
        ...
        /// 用户自定义的数据库实例
        /// </summary>
        public readonly IdleBus<IFreeSql> CustomDBInstance = new(TimeSpan.FromMinutes(5));
        ...
        {
            var keyValue = idKey;
            _ = CustomDBInstance.TryRegister(keyValue, () =>
            {
                try
                {
            ...
            return CustomDBInstance.Get(keyValue);
        }
